...
-- THIS DATABASE IS AN EXAMPLE OF A AN IMMIGRATION FIRM MANAGING DOCUMENTS OF
BENEFICIARIES. IT IS MAINLY COMPOSED OF 8 TABLES
-- WHEN A FOREIGN TRAINED PROFESSIONAL WISHES TO WORK IN THE USA, THEY ARE REQUIRED
A SET OF VARIOUS DOCUMENTS INVOLVING IMMIGRATION
-- THIS INCLUDES LICENSES, RESUMES, WORK PERMITS, TRANSCRIPTS AND A LOT MORE
-- A DOCUMENT MAY BE REQUIRED MORE THAN ONCE AND DIFFERENT VERSIONS ARE REQUIRED OF
IT FROM TIME TO TIME
--DECISIONS AND PETITION ARE BASED ON A SERIES OF DOCUMENTS AND CAN BE REUSED A
MULTITUDE OF TIMES
-- THIS DATABASE PROVIDES A BORDERLINE EXAMPLE OF WHAT AN IMMIGRATION DATABASE MAY
LOOK LIKE
--SURELY THERE ARE MORE DOCUMENTS IN MANAGING AN IMMIGRATION FIRM, AND MULTIPLE
DISCIPLINES, BUT FOR THIS PROJECT, IT IS ONLY ASSUMING MOST BASIC REQUIREMENTS OF
AN APPLICANT
-- AN IMMIGRATION FIRM MAY RECEIVE MULTIPLE DOCUMENTS FOR MULTIPLE PETITIONS FOR A
SINGLE APPLICANT
-- OR YET, AN APPLICANT MAY ONLY HAVE ONE SINGLE PETITION
-- A DECISION IS WHAT DETERMINES THE PETITIONS APPROVAL PROCESS WHETHER APPROVED OR
NOT
--FURTHERMORE, SAMPLE DATA IS INSERTED TO REFLECT SOME IMPORTANT QUERIES OR RESULTS
THAT ARE VITAL TO AN IMMIGRATION FIRM
...
BLocation VARCHAR2(50) NOT NULL, -- LOCATION WHETHER INSIDE OR OUTSIDE OF THE
...
BCountry VARCHAR2(50)NOT NULL, -- REFERS TO THE CURRENT COUNTRY OF THE
BENEFICIARY
...
SponsorAgency VARCHAR2(100), ---- REFERS TO AGENCY OR BUSINESS NAME IF
APPLICABLE
...
CREATE TABLE M_DOCS (
DocsID int NOT NULL PRIMARY KEY, ---- REFERS TO THE UNIQUE IDENTIFIED OF THE
DOCID
...
-- A PETITION HAS A MANY TO MANY RELATIONSHIP WITH DOCUMENTS SINCE A DOCUMENT CAN
BE USED IN MANY PETITIONS
CREATE TABLE M_PETDOCS (
PeteID VARCHAR2(15), ---- REFERS TO PETTION ID
DocsID int NOT NULL, ---- REFERS TO DOCUMENT ID
CONSTRAINT PETDOCSIDPK PRIMARY KEY (PeteID, DocsID) --Use a Constraint of
PeteID and DocsID as a PRIMARY KEY Combination
);
...
(001, 'ALFRED LORZANO', 'OUTSIDE', '305 HOLLARD STREET', 'MANILA',
NULL, 'PHILIPPINES', '46260');
INSERT INTO M_BENEFICIARY VALUES
(002, 'CHAD OKOYE', 'INSIDE', '02 BROADWAY APT A', 'NEW YORK', 'NY',
'USA', '13502');
INSERT INTO M_BENEFICIARY VALUES
(003, 'JONATHAN CHEN', 'OUTSIDE', '12 DUMPLING STREET', 'BEIJING',
NULL, 'CHINA', '90532A');
INSERT INTO M_BENEFICIARY VALUES
(004, 'MARIA OSCAR', 'OUTSIDE', '900 FELIPE STREET', 'TIJUANA', NULL,
'MEXICO', '87445');
INSERT INTO M_BENEFICIARY VALUES
(005, 'ASHE OAK', 'OUTSIDE', '12 SHIBUYA APT 45', 'TOKYO', NULL,
'JAPAN', 'AE950');
INSERT INTO M_BENEFICIARY VALUES
(006, 'DONNIE YEN', 'INSIDE', '3791 LA SALLE STREET APT C', 'CHICAGO',
'IL', 'USA', '60007');
INSERT INTO M_BENEFICIARY VALUES
(007, 'YINGFEI LI', 'INSIDE', '520 OHARE MAIN STREET', 'OHARE', 'IL',
'USA', '65035');
INSERT INTO M_BENEFICIARY VALUES
(008, 'MANUEL GARCIA', 'OUTSIDE', '300 TEQUILA STREET', 'CHIHUAHUA',
NULL, 'MAXICO', '89287');
INSERT INTO M_BENEFICIARY VALUES
(009, 'MELINDA BENITO', 'INSIDE', '56 ORANGE STREET APT A ', 'LOS
ANGELES', 'CA', 'USA', '90005');
INSERT INTO M_BENEFICIARY VALUES
(0010, 'IGOR SHUKARATOV', 'INSIDE', '900 MIDWAY LANE', 'MIDLAND', 'TX',
'USA', '79701');
INSERT INTO M_BENEFICIARY VALUES
(011, 'CHELSEA NABAKOVA', 'OUTSIDE', '8902 CHERUMTA ST', 'RUSSIA',
NULL, 'RUSSIA', '97504-GH');
INSERT INTO M_BENEFICIARY VALUES
(012, 'ANA AMARI', 'INSIDE', '570 HOLLYWOOD BLVD FLR 2', 'HOLLYWOOD',
'FL', 'USA', '32500');
INSERT INTO M_BENEFICIARY VALUES
(013, 'JULIUS ROMAN', 'OUTSIDE', '688 SAMPAGUITA LANE', 'MAKATI CITY',
NULL, 'PHILIPPINES', '15200');
INSERT INTO M_BENEFICIARY VALUES
(014, 'JAKE BOSEMAN', 'OUTSIDE', '902A PEBBLE BLVD ', 'CAIRO', NULL,
'EGYPT', 'P65204');
INSERT INTO M_BENEFICIARY VALUES
(015, 'ALEXIS OBANA', 'INSIDE', '963 POSTDAM STREET', 'POSTDAM', 'NY',
'USA', '13676');
INSERT INTO M_BENEFICIARY VALUES
(016, 'CHEUNG MAE MEL', 'INSIDE', '371 WOODDRIVE WAY', 'CHICAGO', 'IL',
'USA', '60100');
INSERT INTO M_BENEFICIARY VALUES
(017, 'SANDRA PARK', 'OUTSIDE', '788 BUSAN MAIN STREET', 'BUSAN', NULL,
'SOUTH KOREA', '600-011');
INSERT INTO M_BENEFICIARY VALUES
(018, 'JOSEPH NELTHORPE', 'INSIDE', '654 EAST MICHIGAN RD', 'SANTA
MONICA', 'CA', 'USA', '90510');
INSERT INTO M_BENEFICIARY VALUES
(019, 'ANMOL KAPOOR', 'INSIDE', '365 AXEL PARKWAY',
'INDIANAPOLIS','IN', 'USA', '46032');
INSERT INTO M_BENEFICIARY VALUES
(020, 'ROSIE GILL', 'INSIDE', '1002 LAFAYETTE ROAD', 'INDIANAPOLIS',
'IN', 'USA', '46250');
...
INSERT INTO M_FACILITY VALUES
(014, 'EASTERN HEALTH AND CLINIC', '980 NORTH EAST STREET', 'TAMPA', 'FL',
'32460');
INSERT INTO M_FACILITY VALUES
(015, 'STEPPING STONE PTS', '859 10TH STREET', 'ATLANTE', 'GA', '37700');
INSERT INTO M_FACILITY VALUES
(016, 'MEDICAL CENTER OF INDIANA', '12 MAIN STREET', ' INDIANAPOLIS', 'IN',
'46250');
INSERT INTO M_FACILITY VALUES
...
INSERT INTO M_FACILITY VALUES
(020, 'BERRY HOSPITAL AND CLINIC', '556 WESTOWN STREET', 'DES MOINES', 'IA',
'54660');
INSERT INTO M_FACILITY VALUES
...
INSERT INTO M_FACILITY VALUES
(030, 'IN MOTION PHYSICAL THERAPIST', '600 MORISSON STREET FLR A', 'CHARLESTON',
'WV', '25500');
...
INSERT INTO M_DOCS VALUES
(003, 001, 'LICENSE', TO_DATE('01/20/2015', 'MM/DD/YYYY'), TO_DATE('10/31/2018',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(004, 002, 'I-140', TO_DATE('03/22/2015', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(005, 002, 'LICENSE', TO_DATE('03/22/2015', 'MM/DD/YYYY'), TO_DATE('01/01/2028',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(008, 002, 'LICENSE', TO_DATE('03/25/2015', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(009, 003, 'LICENSE', TO_DATE('03/28/2015', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(014, 001, 'LICENSE', TO_DATE('04/30/2015', 'MM/DD/YYYY'), TO_DATE('06/30/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(018, 005, 'PERMIT', TO_DATE('05/17/2015', 'MM/DD/YYYY'), TO_DATE('12/05/2015',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(019, 004, 'I-140', TO_DATE('08/17/2015', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(020, 002, 'LICENSE', TO_DATE('08/22/2015', 'MM/DD/YYYY'), TO_DATE('07/15/2019',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(021, 003, 'PERMIT', TO_DATE('08/22/2015', 'MM/DD/YYYY'), TO_DATE('02/15/2016',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(025, 005, 'LICENSE', TO_DATE('09/22/2015', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(029, 003, 'PERMIT', TO_DATE('10/10/2015', 'MM/DD/YYYY'), TO_DATE('08/15/2016',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(030, 010, 'PERMIT', TO_DATE('10/10/2015', 'MM/DD/YYYY'), TO_DATE('10/12/2016',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(039, 008, 'LICENSE', TO_DATE('02/22/2016', 'MM/DD/YYYY'), TO_DATE('12/15/2018',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(040, 009, 'I-140', TO_DATE('03/01/2016', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(041, 009, 'LICENSE', TO_DATE('03/22/2016', 'MM/DD/YYYY'), TO_DATE('01/15/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(042, 006, 'LICENSE', TO_DATE('03/22/2016', 'MM/DD/YYYY'), TO_DATE('01/15/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(046, 003, 'PERMIT', TO_DATE('05/05/2016', 'MM/DD/YYYY'), TO_DATE('04/15/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(047, 010, 'TRANSCRIPT', TO_DATE('05/03/2016', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(048, 010, 'LICENSE', TO_DATE('05/15/2016', 'MM/DD/YYYY'), TO_DATE('09/15/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(060, 012, 'LICENSE', TO_DATE('08/23/2016', 'MM/DD/YYYY'), TO_DATE('06/15/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(063, 018, 'LICENSE', TO_DATE('03/22/2016', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(064, 020, 'LICENSE', TO_DATE('03/22/2016', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(069, 018, 'LICENSE', TO_DATE('09/20/2016', 'MM/DD/YYYY'), TO_DATE('11/15/2018',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(070, 017, 'RESUME', TO_DATE('09/20/2016', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(071, 014, 'PERMIT', TO_DATE('09/20/2016', 'MM/DD/YYYY'), TO_DATE('09/10/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(072, 014, 'PERMIT', TO_DATE('09/20/2016', 'MM/DD/YYYY'), TO_DATE('06/10/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(079, 004, 'LICENSE', TO_DATE('01/18/2017', 'MM/DD/YYYY'), TO_DATE('07/01/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(082, 011, 'PERMIT', TO_DATE('01/25/2017', 'MM/DD/YYYY'), TO_DATE('12/31/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(085, 013, 'PERMIT', TO_DATE('01/30/2017', 'MM/DD/YYYY'), TO_DATE('01/15/2028',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(090, 003, 'PERMIT', TO_DATE('03/05/2017', 'MM/DD/YYYY'), TO_DATE('10/31/2017',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(091, 009, 'I-140', TO_DATE('03/12/2017', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(092, 015, 'LICENSE', TO_DATE('03/12/2017', 'MM/DD/YYYY'), TO_DATE('12/31/2021',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(093, 016, 'LICENSE', TO_DATE('03/15/2017', 'MM/DD/YYYY'), TO_DATE('12/31/2021',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(100, 003, 'PERMIT', TO_DATE('04/19/2017', 'MM/DD/YYYY'), TO_DATE('11/01/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(103, 012, 'LICENSE', TO_DATE('04/25/2017', 'MM/DD/YYYY'), TO_DATE('03/15/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(104, 007, 'PERMIT', TO_DATE('04/25/2017', 'MM/DD/YYYY'), TO_DATE('04/25/2019',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(105, 009, 'PERMIT', TO_DATE('04/25/2017', 'MM/DD/YYYY'), TO_DATE('03/06/2018',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(111, 013, 'LICENSE', TO_DATE('07/22/2017', 'MM/DD/YYYY'), TO_DATE('12/15/2018',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(117, 018, 'LICENSE', TO_DATE('02/01/2018', 'MM/DD/YYYY'), TO_DATE('06/10/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(121, 014, 'LICENSE', TO_DATE('03/22/2018', 'MM/DD/YYYY'), TO_DATE('06/22/2019',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(122, 015, 'I-140', TO_DATE('03/28/2018', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(123, 020, 'LICENSE', TO_DATE('03/22/2018', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(126, 016, 'LICENSE', TO_DATE('03/22/2018', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(131, 021, 'LICENSE', TO_DATE('06/05/2018', 'MM/DD/YYYY'), TO_DATE('01/19/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(134, 001, 'LICENSE', TO_DATE('06/25/2018', 'MM/DD/YYYY'), TO_DATE('07/15/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(135, 005, 'LICENSE', TO_DATE('06/25/2018', 'MM/DD/YYYY'), TO_DATE('11/23/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(141, 010, 'PERMIT', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('11/20/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(142, 011, 'LICENSE', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('05/31/2019',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(143, 011, 'PERMIT', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('06/13/2018',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(144, 012, 'LICENSE', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('07/15/2018',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(145, 015, 'LICENSE', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('12/25/2023',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(146, 015, 'PERMIT', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('10/31/2025',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(147, 017, 'RESUME', TO_DATE('07/01/2018', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(148, 017, 'PERMIT', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('07/15/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(149, 020, 'PERMIT', TO_DATE('07/01/2018', 'MM/DD/YYYY'), TO_DATE('06/10/2022',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(150, 003, 'PERMIT', TO_DATE('05/10/2018', 'MM/DD/YYYY'), TO_DATE('01/15/2021',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(153, 019, 'PERMIT', TO_DATE('09/10/2018', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(156, 015, 'LICENSE', TO_DATE('10/22/2018', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(157, 017, 'LICENSE', TO_DATE('10/22/2018', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(161, 002, 'PERMIT', TO_DATE('11/23/2018', 'MM/DD/YYYY'), TO_DATE('11/30/2019',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(164, 010, 'LICENSE', TO_DATE('12/22/2018', 'MM/DD/YYYY'), TO_DATE('12/31/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(165, 011, 'I-140', TO_DATE('01/19/2019', 'MM/DD/YYYY'), NULL);
INSERT INTO M_DOCS VALUES
(166, 012, 'LICENSE', TO_DATE('02/22/2019', 'MM/DD/YYYY'), TO_DATE('02/22/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(167, 012, 'LICENSE', TO_DATE('02/22/2019', 'MM/DD/YYYY'), TO_DATE('05/06/2021',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(170, 020, 'PERMIT', TO_DATE('02/23/2019', 'MM/DD/YYYY'), TO_DATE('06/15/2022',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(173, 012, 'PERMIT', TO_DATE('04/15/2019', 'MM/DD/YYYY'), TO_DATE('12/15/2019',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(176, 013, 'PERMIT', TO_DATE('04/23/2019', 'MM/DD/YYYY'), TO_DATE('08/10/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(177, 012, 'LICENSE', TO_DATE('05/10/2019', 'MM/DD/YYYY'), TO_DATE('11/01/2019',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(180, 007, 'PERMIT', TO_DATE('06/10/2019', 'MM/DD/YYYY'), TO_DATE('01/05/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(181, 006, 'LICENSE', TO_DATE('06/19/2019', 'MM/DD/YYYY'), TO_DATE('01/05/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT INTO M_DOCS VALUES
(184, 009, 'PERMIT', TO_DATE('10/06/2019', 'MM/DD/YYYY'), TO_DATE('12/15/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
(185, 012, 'LICENSE', TO_DATE('10/10/2019', 'MM/DD/YYYY'), TO_DATE('03/15/2020',
'MM/DD/YYYY'));
INSERT INTO M_DOCS VALUES
...
INSERT ALL INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided)
VALUES ( 001, 'A5612385486122', 'DENIED', 'EDUCATION', TO_DATE('12/15/2015',
'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 002,
'G1795602359172', 'DENIED', 'EXPERIENCE', TO_DATE('01/12/2016', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES (003,
'C4226854930284', 'DENIED', 'EXPERIENCE', TO_DATE('03/15/2016', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES (004,
'C7005988363131', 'ACCEPTED', 'GRANTED', TO_DATE('10/01/2016', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES (005,
'H7392048445617', 'ACCEPTED', 'GRANTED', TO_DATE('01/05/2017', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES (006,
'H7392620581025', 'DENIED', 'FINANCIAL', TO_DATE('01/25/2017', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 007,
'C7005612109941', 'DENIED', 'FINANCIAL', TO_DATE('12/1/2017', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 008,
'C4226065829422', 'DENIED', 'EXPERIENCE', TO_DATE('02/14/2018', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 009,
'G1795112049502', 'ACCEPTED', 'GRANTED', TO_DATE('02/14/2018', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 010,
'G1795198294050', 'DENIED', 'EDUCATION', TO_DATE('06/28/2018', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 011,
'C4226112579204', 'DENIED', 'EDUCATION', TO_DATE('12/20/2018', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 012,
'A5612015829202', 'ACCEPTED', 'GRANTED', TO_DATE('11/03/2019', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 013,
'C7005019502052', 'DENIED', 'FINANCIAL', TO_DATE('11/03/2019', 'MM/DD/YYYY'))
INTO M_DECISION (DecisionID, PetitionID, Decision, Reason, Decided) VALUES ( 014,
'C4226029402029', 'DENIED', 'EDUCATION', TO_DATE('12/15/2019', 'MM/DD/YYYY'))
SELECT * FROM DUAL;
SELECT *
FROM M_DECISION;
--RESET FOR VIEWS
...
-- IT IS NECESSARY TO REFER TO THIS VIEW WHEN FILING A PETITION TO KEEP TRACK OF
SALARY INVENTORY
--IT MERGES THE FACILITY AND WAGE TABLE
CREATE VIEW M_CURRENTWAGE
AS SELECT FACINAME, FACISTATE, WDEGREE, EXPIRATION, TO_CHAR(SALARY,
'$999,999.99') "SALARY"
...
AS SELECT M_PETDOCS.PETEID, M_BENEFICIARY.BNAME, M_PETITION.PETITIONTYPE,
M_PETITION.FILEDDATE
FROM M_BENEFICIARY, M_PETITION, M_DOCS, M_PETDOCS
WHERE M_BENEFICIARY.BeneID = M_DOCS.BeneID and M_DOCS.DOCSID = M_PETDOCS.DOCSID
AND M_PETDOCS.PETEID = M_PETITION.PETITIONID AND M_DOCS.DOCTYPE= 'I-140'
...
--AFTER SHOWING THE BENEFICIARY, THIS KEEPS TRACK OF THOSE WHO SPONSORED THE
PETITION
...
--GROUP BY ROLLUP
--USES MIN FUNCTIONS
--SUMMARIZES ALL WAGES THAT CAN BE PAID TO AN APPLICANT MINIUM BY STATE AND BY
DEGREE
...
--GROUP BY ROLLUP
--USES MIN FUNCTIONS
--SUMMARIZES ALL WAGES THAT CAN BE PAID TO AN APPLICANT MAXIMUM BY STATE AND BY
DEGREE
...
HAVING COUNT(SPONSORNAME)>=(SELECT AVG(COUNT(SPONSORNAME)) FROM M_SPONSORED GROUP
BY SPONSORNAME);
...
SELECT BNAME, DOCTYPE, TO_CHAR(DOCEXPIRATION,'MONTH')AS MONTH,
ROUND(MONTHS_BETWEEN(DOCEXPIRATION, SYSDATE),2) AS MONTHS_REMAINING
FROM M_EXPIRDOCS;
SAVEPOINT CLASSC;
ROLLBACK TO CLASSC;
--USING MERGE
...
MERGE INTO M_SPONSOR USING M_SPONSOR2 on
(M_SPONSOR.SPONSORID=M_SPONSOR2.Sponsor2ID)
WHEN MATCHED THEN UPDATE SET M_SPONSOR.SPONSORNAME = M_SPONSOR2.SPONSOR2NAME
WHEN NOT MATCHED THEN INSERT (M_SPONSOR.SPONSORID,M_SPONSOR.SPONSORNAME,
M_SPONSOR.SPONSORAGENCY, M_SPONSOR.SPONSORCONTACT) VALUES
(M_SPONSOR2.SPONSOR2ID,M_SPONSOR2.SPONSOR2NAME,M_SPONSOR2.SPONSOR2AGENCY,M_SPONSOR2
.SPONSOR2CONTACT);
--CREATING AN INDEX
